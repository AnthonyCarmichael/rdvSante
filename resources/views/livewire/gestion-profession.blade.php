<div class="mx-16">
        ...
        <table class="w-full border-solid border border-black mb-4">
            <thead class="sticky top-0">
                <tr>
                    ...
                    <th class="border-solid border-b-2 border-black bg-mid-green text-left w-3/8 pl-2">Organisation
                        associée
                    </th>
                    <th class="border-solid border-b-2 border-black bg-mid-green text-left w-3/8 pl-2">Numéro de membre
                    </th>
                    <th class="border-solid border-b-2 border-black bg-mid-green text-left w-3/8 pl-2">Date d'expiration
                    </th>
    ...
    <x-modal title="Ajouter une profession et/ou l'organisation liée" name="ajouterOrg" :show="false">
        ...
        <form wire:submit.prevent="ajoutOrg" class="bg-white p-4 rounded-lg">
            <div class="grid grid-cols-2 gap-y-4 pr-32">
                ...
                <input wire:model="profession" type="text" list="profession" class="h-8 text-xs ml-2">
                <datalist wire:model="profession" id="profession" name="profession" class="h-8 text-xs ml-2">
                    @foreach ($professions as $p)
                ...
                <input wire:model="organisation" type="text" list="organisation" class="h-8 text-xs ml-2">
                <datalist wire:model="organisation" id="organisation" name="organisation" class="h-8 text-xs ml-2">
    ...
    <x-modal title="Supprimer sa profession et/ou l'organisation liée" name="supprimerOrg" :show="false">
        ...
        <div class="flex justify-center mt-4">
            ...
            <button class="w-3/12 bg-selected-green mx-1 my-1 rounded p-0.5" type="button"
                wire:click="supprimerOrg('org')">L'organisation</button>

            <button class="w-3/12 bg-selected-green mx-1 my-1 rounded p-0.5" type="button"
                wire:click="supprimerOrg('pro')">La profession</button>
        </div>
    </x-modal>
</div>
